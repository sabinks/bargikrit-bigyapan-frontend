        ...
        <div className="space-y-1 my-2">
            ...
            <div className="mt-1">
                <textarea
                    ...
                    cols={cols}
                    className={classNames(
                        "appearance-none block w-full h-52 px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm",
                        textAreaClassName,
                        errorClass
                    )}
                    {...rest}
